class Matrix {
  ...
  public add(matrix1: Matrix, matrix2: Matrix): Matrix | undefined {
  ...
  private calculateSum(matrix1: Matrix, matrix2: Matrix): Matrix {
  ...
  public multiply(matrix1: Matrix, matrix2: Matrix): Matrix | undefined {
  ...
  private calculateProduct(matrix1: Matrix, matrix2: Matrix): Matrix {
